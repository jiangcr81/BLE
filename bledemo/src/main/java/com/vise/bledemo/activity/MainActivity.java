...
import com.sjhua.extra.xsnow.event.BusManager;
import com.sjhua.extra.xsnow.event.Subscribe;
import com.sjhua.extra.xsnow.permission.OnPermissionCallback;
import com.sjhua.extra.xsnow.permission.PermissionManager;
    ...
    private void init() {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                intent.putExtra(DeviceScanActivity.EXTRAS_FILTER_TYPE, 0);
                startActivity(intent);
            }
        });
        
        Button btn_scan_all = (Button) findViewById(R.id.button_scan_all);
        btn_scan_all.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        Button btn_scan_filter_name = (Button) findViewById(R.id.button_filter_name);
        btn_scan_filter_name.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(MainActivity.this, DeviceScanActivity.class);
                intent.putExtra(DeviceScanActivity.EXTRAS_FILTER_TYPE, 1);
                intent.putExtra(DeviceScanActivity.EXTRAS_DEVICE_NAME, "NEUTRAL");
                startActivity(intent);
            }
        });
