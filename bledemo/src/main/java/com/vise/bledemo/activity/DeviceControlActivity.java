...
import com.sjhua.extra.xsnow.cache.SpCache;
...
public class DeviceControlActivity extends AppCompatActivity {
		...
		findViewById(R.id.send).setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				//  ToastUtil.showToast(DeviceControlActivity.this, "Please input command!");
					Toast.makeText(DeviceControlActivity.this, "Please input command!", Toast.LENGTH_LONG).show();
					return;
				}
				if (!isHexData(mInput.getText().toString())) {
				//	ToastUtil.showToast(DeviceControlActivity.this, "Please input hex data command!");
					Toast.makeText(DeviceControlActivity.this, "Please input hex data command!", Toast.LENGTH_LONG).show();
					return;
				}
	...
	public void showConnectedDevice(ConnectEvent event) {
		if (event != null) {
			...
			//	ToastUtil.showToast(DeviceControlActivity.this, "Connect Success!");
				Toast.makeText(DeviceControlActivity.this, "Connect Success!", Toast.LENGTH_LONG).show();
				...
				//	ToastUtil.showToast(DeviceControlActivity.this, "Disconnect!");
					Toast.makeText(DeviceControlActivity.this, "Disconnect!", Toast.LENGTH_LONG).show();
				} else {
				//	ToastUtil.showToast(DeviceControlActivity.this, "Connect Failure!");
					Toast.makeText(DeviceControlActivity.this, "Connect Failure!", Toast.LENGTH_LONG).show();
				}
	...
	public boolean onCreateOptionsMenu(final Menu menu) {
		...
		if (BluetoothDeviceManager.getInstance().isConnected(mDevice)) {
			...
			Log.i(TAG, "onCreateOptionsMenu isConnected " + simpleExpandableListAdapter.toString());
			showDefaultInfo();
		} else {
