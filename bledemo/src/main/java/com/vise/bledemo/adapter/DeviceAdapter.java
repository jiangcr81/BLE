...
import com.sjhua.extra.xsnow.ui.adapter.HelperAdapter;
import com.sjhua.extra.xsnow.ui.adapter.helper.HelperViewHolder;
...
public class DeviceAdapter extends HelperAdapter<BluetoothLeDevice> {
	...
	public void HelpConvert(HelperViewHolder viewHolder, int position, BluetoothLeDevice bluetoothLeDevice) {
		...
		if (bluetoothLeDevice != null && bluetoothLeDevice.getDevice() != null) {
			...
			deviceScanRecordTv.setText(mContext.getString(R.string.header_scan_record) + ":" + HexUtil.encodeHexStr(bluetoothLeDevice.getScanRecord()));
		}
	}
}
